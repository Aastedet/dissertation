...
\[Describe overall proportion of migrants and migration patterns/groups/causes: Summarise https://www.dst.dk/da/Statistik/nyheder-analyser-publ/bagtal/2022/2022-08-18-fakta-om-indvandrere & for 2019: https://www.dst.dk/da/Statistik/nyheder-analyser-publ/Publikationer/VisPub?cid=29446\]
...
### Infrastructure of Danish data on migrants

In the context of Danish statistics and this PhD project, both refugees and immigrants are referred to as migrants after obtaining residence. In Danish register data, a migrant's country of origin is defined by Statistics Denmark according to the following rules (paraphrased):
...
Civil registration data on migrants is collected during the residence application process. Generally, registrations pertaining to events that occurred prior to the migration require technical evidence or legal proof from the issuing authority of the country where the event occurred. However, in cases where such documentation is unavailable, e.g. date of birth, registrations may be supported by undocumented information provided by the migrant. [@eventsabroad] In cases where information was not systematically collected at the time of migration, e.g. level of education attained before migration, surveys may be used to collect this data retrospectively, or it may be imputed based on the available data.[@educationmigrants]

### Migrant groups in Denmark

Migrants from more than 200 different countries of origin reside in Denmark, making it a very heterogenous group.

-   

    -   \>200 countries of origin among immigrants in Denmark: heterogeneous group

    -   Migration patterns in Denmark governed by migration politics: fig. 1.11 (reason for residence permits through time)

    -   Migrants with different origins have different contexts:

        -   reason for residence permit (tab. 1.9 + 1.10)

            -   Reason correlates with origin

        -   Time of migration (fig. 1.4) and current age (tab. 1.3)

-   Very specific categories - rarely used, and not in a population-wide study of this size?

-   Migrants vs. descendants:

    -   diff. ages: fig. 1.4

    -   Indications of different diabetes risk (Bennet)

-   Context of each migrant category.
