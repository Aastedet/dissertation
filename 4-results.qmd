...
This chapter presents the nationwide register-based T2D cohort identified by the OSDC and details the flow of individuals through the algorithm. Next, the main results of each study associated with the dissertation are presented. Additional details are available in the respective papers and their supplementary material, attached in [Appendix -@app2-papers].
...
::: {#fig-osdc-inc-flow}
[![](figures/osdc_flow/inclusion_flow.png)](https://aastedet.github.io/dissertation/figures/osdc_flow/inclusion_flow.svg)
...
::: {#fig-osdc-type-flow}
[![](figures/osdc_flow/type_flow.png)](https://aastedet.github.io/dissertation/figures/osdc_flow/type_flow.svg)
...
Prevalence in native Danes and relative risk in each migrant group with 95% CIs.
