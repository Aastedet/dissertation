...
This chapter presents the nationwide register-based T2D cohort identified by the OSDC and details the flow of individuals through the algorithm. Next, the main results of each study associated with the dissertation are presented. Additional details are available in the respective papers and their supplementary material, attached in @sec-papers.
