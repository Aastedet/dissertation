...
-   Population flow numbers in this example correspond to a regional source population.
-   Abbreviations: OSDC: Open-Source Diabetes Classifier. RSCD: Register for selected Chronic Diseases. T1D: Type 1 diabetes. T2D: Type 2 diabetes. PCOS: Polycystic ovary syndrome. GDM: Gestational diabetes. GLD: Glucose-lowering drugs.
